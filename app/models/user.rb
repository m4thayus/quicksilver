...
class User < ApplicationRecord
  ...
  ENGINEERS = %w[peterv deepthie elizabethk jamesa biancac amitp].map { |u| "#{u}@mercuryanalytics.com" }.freeze
  MEMBERS = %w[ronh jail zoef].map { |u| "#{u}@mercuryanalytics.com" }.freeze
